...
**Open the source code and start editing!**
    ...
    Open the `GATSBY-STARTER-HELLO-BJS-BASIC` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
